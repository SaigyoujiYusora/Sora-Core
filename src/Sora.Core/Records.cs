...
public sealed record SceneDocument(string Name, BoneRecord[] Bones, MeshRecord[] Meshes,
    MaterialRecord[] Materials, ClipRecord[] Clips, TextureRecord[]? Textures = null, TextureDescriptor[]? TextureDescriptors = null, HeadReferenceRecord? HeadReference = null);
