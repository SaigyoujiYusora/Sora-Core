...
public static class NativeFaceMorph
{
    ...
    public static void Validate(FaceDriverRecord face,SceneDocument scene) {
        ...
        for(int i=0;i<additional.Length;i++)
        {
            ...
            Validation.Require(source.AvatarCab.Equals(face.AvatarCab,StringComparison.OrdinalIgnoreCase)&&source.AvatarObject==face.AvatarObject&&source.DataType==1&&double.IsFinite(source.RestFitDegrees)&&source.RestFitDegrees>=0,"Incompatible supplementary Avatar or data type");
